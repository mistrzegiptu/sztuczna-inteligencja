...
# remove outliers
# your_code
df = df.loc[lambda x: x.GrLivArea < 4000, :]
...
replace_na(df, 'CentralAir', value = 'Yes')
...
column_transformer = ColumnTransformer(transformers= [("categorical_pipeline", categorical_pipeline, categorical_features),
